...
//
        ...
        studentManager.enrollStudent("Xuan Duy");
        studentManager.enrollStudent("Duc Quy");
        studentManager.listStudents();
        studentManager.expelStudent("Xuan Duy");
        studentManager.listStudents();

        //commands ================================================================================
        Student student = new Student(00237,"Khanh Duy");
        ...
        //Memento ================================================================================
        Student student12 = new Student("Steve Job", "22",3.4f);
        ...
        student12.updateInfo("Job", "22",3.5f);
